...
//
// This file is a port of cloud.google.com/go/internal/fields (from
// cloud.google.com/go@v0.121.4) so that github.com/apstndb/spanenc can
// mirror the Cloud Spanner Go client struct-field semantics without
// depending on an internal package. Keep diffs against upstream minimal
// to ease tracking upstream changes.
...
// tEqual stands in for cloud.google.com/go/internal/testutil.Equal in this
// port; the upstream default cmp options (proto, big.Rat, NaN comparers) are
// not exercised by these tests.
func tEqual(x, y interface{}, opts ...cmp.Option) bool {
...
func TestAgainstJSONEncodingWithTags(t *testing.T) {
	...
	if !tEqual(got, want, cmp.AllowUnexported(S2{})) {
		t.Errorf("got\n%+v\nwant\n%+v", got, want)
	}
}
...
func fieldsEqual(f1, f2 *Field) bool {
	...
	return f1.Name == f2.Name &&
		...
		f1.Type == f2.Type &&
		tEqual(f1.ParsedTag, f2.ParsedTag)
}
